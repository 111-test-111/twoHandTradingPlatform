...
Page({
    ...
    viewUserAgreement() {
        wx.showModal({
            title: '用户协议',
            content: '校园二手交易平台用户协议\n\n1. 用户资格：本平台仅限校园内学生使用，注册时需验证学生身份信息\n\n2. 交易规则：用户应当诚信交易，不得发布虚假商品信息，禁止出售违禁物品\n\n3. 交易安全：平台建议用户在校内公共场所进行当面交易，保证交易安全\n\n4. 信息真实：用户承诺提供真实个人信息，不得冒充他人或使用虚假信息\n\n5. 平台责任：平台仅提供信息撮合服务，交易风险由用户自行承担',
            showCancel: false
        });
    },
    ...
    viewPrivacyPolicy() {
        wx.showModal({
            title: '隐私政策',
            content: '校园二手交易平台隐私政策\n\n1. 信息收集：我们收集用户的基本信息、地理位置和交易记录，用于提供服务\n\n2. 信息使用：收集的信息仅用于服务提供、身份验证和交易安全保障\n\n3. 信息保护：我们采用加密等技术手段保护用户信息安全，未经授权不会向第三方披露\n\n4. 位置服务：使用位置信息进行地理位置展示、同校匹配和交易推荐，可随时关闭\n\n5. 用户权利：用户有权查看、更正个人信息，也可申请注销账号',
            showCancel: false
        });
    },
    ...
    aboutUs() {
        wx.showModal({
            title: '关于我们',
            content: '校园二手交易平台\n\n我们是一个专注于校园内二手物品交易的平台，旨在为大学生提供安全、便捷的二手交易环境\n\n使命：促进校园资源循环利用，减少浪费，让闲置物品重新焕发价值\n\n特色：\n· 校园专属：专为校园师生设计\n· 安全可靠：实名认证保障交易安全\n· 便捷沟通：内置即时通讯功能\n· 地理位置：基于位置的同校匹配\n\n联系方式：\n客服电话：13705267759\n邮箱：support@campus-trade.com',
            showCancel: false
        });
    },
